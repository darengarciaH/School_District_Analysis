...
### District Summary, School Summary, and Thomas High School Performance
  * The district summary scores were only slightly affected, given that there are still more than 38,000 test scores (observations) in the data. The picture below shows our district summary *with* THS 9th grade scores:
 ...
 * As stated previously, the academic dishonesty scandal only affects scores for Thomas High School. In the school summary, all other schools remain with the same data except Thomas High School since we remove the math and reading scores for 9th graders. Here are the scores for THS *with* 9th grade scores:
...
<img width="984" alt="Screen Shot 2021-11-30 at 5 55 43 PM" src="https://user-images.githubusercontent.com/92702922/144146893-2e322d59-c333-4455-b00c-edf707b79896.png">
...
<img width="294" alt="Screen Shot 2021-11-30 at 5 26 50 PM" src="https://user-images.githubusercontent.com/92702922/144144279-5c6c314c-1fdd-4476-9299-d0af067fe05c.png">
...
These are the results *without* the THS 9th grade scores:
...
Similar to other results, the overall passing rate, math passing rate, and reading passing rate decreased by less than a tenth of a percentage point. Average math scores also fell by a similar amount, and average reading scores increased by a similar amount. Generally speaking, these metrics remained relatively stable.
 * When schools are sorted by their size (number of students), the exclusion of Thomas High School 9th grade scores affect the *Medium* category, which includes schools that have between 1000-2000 students. This is the breakdown of math and reading scores *with* THS 9th grade scores:
...
This is the breakdown of math and reading scores *without* the THS 9th grade scores:
...
Again, only the average reading score increases slightly. Average math score, passing math rate, passing reading rate, and the overall rate all decrease slightly.
 * When looking at test scores grouped by school type, we see that the charter school category is affected since Thomas High School is a charter school. This is the breakdown of math and reading scores *with* THS 9th grade scores:
...
The trend remains similar. Only the average reading score increases slightly. Average math score, passing math rate, passing reading rate, and the overall rate all decrease slightly as a result of the THS 9th grade score exclusion.
## Summary
